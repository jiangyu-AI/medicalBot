...
for names_id in baike_names_id:
    nameChRaw, nameEnRaw, baike_id = names_id.split('\t')
    nameCh = nameChRaw.lower()
    #nameEn = nameEnRaw.lower()
    if nameEn in labelEn_id_dic:
        wiki_id = labelEn_id_dic[nameEn]
        matches_by_nameEn.append(baike_id.strip('\n') + '\t' + wiki_id.strip('\n') + '\t' + nameEn + '\t' + nameCh)
...
matches_by_nameEn_file = '/home/jyu/data/matches_by_nameEn.txt'
matches_by_nameCh_file = '/home/jyu/data/matches_by_nameCh.txt'
